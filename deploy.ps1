...
Write-Host "--- Iniciando Build para Repertório (arm64) ---" -ForegroundColor Cyan
...
# 3. Transferência e Instalação via ADB
$DeviceID = "b6fd1f9e"
...
if ($LASTEXITCODE -ne 0) { 
    Write-Host "AVISO: A instalação direta falhou. Verifique as permissões USB no dispositivo." -ForegroundColor Yellow
}
